...
const CardTestimoni: React.FunctionComponent<ICardTestimoniProps> = ({
  ...
  return (
    <div className="w-full md:w-[400px] p-6 rounded-lg shadow-lg flex flex-col justify-between" style={{backgroundColor: bgColor}}>
      <p className="text-white text-sm">{testimonial}</p>
      <div className="flex items-center mt-4">
        <img className="h-16 w-16 rounded-full border-4 border-white" src={imageUrl} alt={`Photo of ${name}`} />
        <div className="ml-4">
